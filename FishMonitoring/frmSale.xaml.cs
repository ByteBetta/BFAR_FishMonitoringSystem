...
namespace WpfPosApp
{
    ...
    /// </summary>
    public partial class frmSale : System.Windows.Controls.UserControl
    {
        ...
        public frmSale(frmCashierDashboard frm, Main frm2)
        {
            InitializeComponent();
            Colors();
            cd = frm;
       ...
       // ProductDAL pDAL = new ProductDAL();
        ...
        private void txtPDSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            //FishBLL fishdata = pDAL.GetProductsForTransaction(keyword);

            // Set the values on textboxes 
           // txtPDName.Text = fishdata.Full_Name;
          //  txtPDInventory.Text = fishdata.Quantity.ToString();
           // txtPDPrice.Text = fishdata.Price.ToString();
         //   imgLoc = fishdata.Img;
        ...
        private void btnCheckout_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                DealCustBLL dc = dcDAL.getIDofFisherman(deaCustName);
                ...
                using (TransactionScope scope = new TransactionScope())
                {
                   ...
                   // bool w = tDAL.Insert_Transaction(transaction, out TransactionID);
                    ...
                    for (int i = 0; i < transactionDT.Rows.Count; i++)
                    {
                        ...
                        //ProductBLL fishdata = pDAL.GetProductIDFromName(ProductName);

                  //      transactionDetail.ProdID = fishdata.ProdID;
                   ...
                   //         x = pDAL.IncreaseProduct(transactionDetail.ProdID, transactionDetail.qty);
                    ...
                    if (success == true)
                    {
                        frmSaleReceipt frm = new frmSaleReceipt(this);
                        frm.Show();
