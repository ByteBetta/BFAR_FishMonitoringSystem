...
namespace WpfPosApp
{
    public partial class frmDataReport : Form
    {
        ...
        public frmDataReport(frmUser frm, frmDealersandCustomers frm2, frmEmployee frm3, frmProduct frm4, frmDealers frm5)
        {
            InitializeComponent();
        ...
        public void LoadUserReport()
        {
            try
            {
                ...
                cn.Open();
                da.SelectCommand = new SqlCommand("SELECT UserID, Name, Surname, UserName, Password, UserType, SEX, Birth_Date FROM Login", cn);
        ...
        public void LoadEmployeeReport()
        {
            try
            {
                ...
                cn.Open();
                da.SelectCommand = new SqlCommand("SELECT EmpID, Name, Surname, SEX, Birth_Date, Age, Address, Mobile, DateOfReciving, Sallary  FROM Employee", cn);
        ...
        public void LoadProducReport()
        {
            try
            {
                ...
                cn.Open();
                da.SelectCommand = new SqlCommand("SELECT ProdID, Manufactor, Model, Full_Name, Price, Category, Description, Year, Warranty  FROM Product", cn);
