...
namespace WpfPosApp.DAL
{
    class userDAL
    {
        ...
        public bool Insert(UserBLL u)
        {
            ...
            try
            {
                string sql = "INSERT INTO Login(Name, Surname, UserName, Password, UserType, SEX, Birth_Date, Img, Added_Date, Added_By) VALUES (@Name, @Surname, @UserName, @Password, @UserType, @SEX, @Birth_Date, @Img, @Added_Date, @Added_By)";
        ...
        public bool Update(UserBLL u)
        {
            ...
            try
            {
                ...
                {
                    string sql = "UPDATE Login SET Name=@Name,Surname=@Surname,UserName=@UserName,Password=@Password,UserType=@UserType,SEX=@SEX,Birth_Date=@Birth_Date, Img=@Img,Added_Date=@Added_Date, Added_By=@Added_By Where UserID=@UserID";
                    SqlCommand cmd = new SqlCommand(sql, db.con);
