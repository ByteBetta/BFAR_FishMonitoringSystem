    ...
    class TransactionDAL
    {
        ...
        public bool Insert_Transaction(TransactionBLL t, out int TransactionID)
        {
            ...
            //Create a SqlConnection first
                ...
                string sql = "INSERT INTO tblTransaction (type, DealCustID, grandTotal, transaction_date, tax, discount) VALUES (@type, @DealCustID, @grandTotal, @transaction_date, @tax, @discount); SELECT @@IDENTITY;";
                ...
                cmd.Parameters.AddWithValue("@DealCustID", t.DealCustID); 
        ...
        public bool Insert_Transaction_P(TransactionBLL t, out int TransactionID)
        {
            ...
            //Passing the value to sql query using cmd
            cmd.Parameters.AddWithValue("@type", t.type);
            cmd.Parameters.AddWithValue("@DealCustID", t.DealerID);
            cmd.Parameters.AddWithValue("@grandTotal", t.grandTotal);
            cmd.Parameters.AddWithValue("@transaction_date", t.transaction_date);
            cmd.Parameters.AddWithValue("@tax", t.tax);
            cmd.Parameters.AddWithValue("@discount", t.discount);
